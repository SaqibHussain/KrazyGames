<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HandheldPSPAccessories.aspx.cs" Inherits="KrazyGames.Handheld.HandheldPSPAccessories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <h4> Refine your search</h4>
        ...
        <div class="refine_section_wrapper">
            ...
            to £<asp:TextBox ID="tbPriceMax" runat="server" Width="35%"></asp:TextBox>
        </div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField SortExpression="Sort" ControlStyle-Width="140">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="lnkbtnShoppingCart" runat="server" Text='Add to Shopping Cart'
                                OnCommand="lnkbtnShoppingCart_Command" CommandName="ShoppingCart" CommandArgument='<%#Eval("ProductID") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
